...
sudo docker run --name ${docker_name} -p 80:80 -v $PWD/nginx-official/www:/www -v $PWD/nginx-official/conf/nginx.conf:/etc/nginx/nginx.conf -v $PWD/logs:/wwwlogs -d nginx
